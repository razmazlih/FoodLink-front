      ...
      <div className="how-it-works-content">
        ...
        <ol className="how-it-works-steps">
          <li className="step-item">
            ...
            <a href="https://github.com/razmazlih/UserBase" target="_blank" rel="noopener noreferrer" className="service-link">GitHub</a>
          </li>
          <li className="step-item">
            ...
            <br/>
            Links: 
            <a href="https://dishboard.onrender.com" target="_blank" rel="noopener noreferrer" className="service-link">Documentation</a> | 
            <a href="https://github.com/razmazlih/DishBoard" target="_blank" rel="noopener noreferrer" className="service-link">GitHub</a>
          </li>
          <li className="step-item">
            ...
            <br/>
            Links: 
            <a href="https://orderline.onrender.com/docs" target="_blank" rel="noopener noreferrer" className="service-link">Documentation</a> | 
            <a href="https://github.com/razmazlih/OrderLine" target="_blank" rel="noopener noreferrer" className="service-link">GitHub</a>
          </li>
          <li className="step-item">
